...
const Workflow = (props) => {
  ...
  const getTaskSettings = () => {
    return tasks.map((task) =>
      <div
        className="mercury__task__settings"
        data-is-viewing={task.slug === viewingTaskSlug}
      >
        <Formik
          ...
          render={props => (
            ...
            >
              ...
              <Footer
                ...
                isActive={task.slug === activeTaskSlug}
                isViewing={task.slug === viewingTaskSlug}
                nextTask={getTaskBySlug(nextTaskSlug)}
